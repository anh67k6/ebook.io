let data = [
    {truyen : {
            ...
            noidung :[
                 {  chapter : "Chương 1",
                    name: 'Bị đá rồi',
                    content: `“Vi Vi, đến Vong Tình Đảo đi, chúng ta ly hôn!”
        ...
        Vi Vi trả lời tin nhắn lại: “Muội đến ngay đây.”
        
        Nhân vật “Lô Vĩ Vi Vi” trong game của Vi Vi lên ngựa, bắt đầu phi về phía Vong Tình Đảo. “Lô Vĩ Vi Vi” là một Hồng y Nữ hiệp được trang bị đầy mình.
        ...
        “Chồng trước” chớp mắt cái đã cưới người con gái khác, tuy chỉ có chút chút tình cảm cách mạng với Chân Thủy, Vi Vi vẫn không thể không thấy ủ rũ, đập đầu vào bàn (đứa trẻ này hễ buồn là vậy đấy…), gào to: “Không chịu vậy đâu, lấy sắc dụ người!!!”
        Câu này Vi Vi không gào trong trò chơi mà là trong ký túc xá, thế là lập tức cô nàng bị bạn cùng phòng dùng gối đập vào đầu:
        
        “Bối Vi Vi! Đại mĩ nữ chân chính như cậu còn gào như thế thì bọn tớ còn sống được nữa không?”
        ...
        “Phụt!” Vi Vi phun hết nước lên màn hình vi tính.`
                 ...
                 {  chapter : "Chương 2",
                    name : 'Vi vi cướp chồng',
                    content: `Vi Vi muốn khóc mà không có nổi nước mắt, bất lực gõ chữ phản hồi: “Bạn à, mình chỉ là đến xem… cho…vui … thôi… mà…”

        Buổi tối 8 giờ đúng.
        
        Hồng Y Nữ Hiệp lưng vác đại đao uy phong ngời ngời đứng trên cầu Chu Tước ở thành Trường An.
        
        Đây là nơi kiệu hoa phải đi qua khi làm lễ.
        ...
        Cô chỉ mới đăng nhập vào game, sau đó đứng trên cầu Chu Tước, rồi đi nhà vệ sinh, nhiều nhất cũng chỉ năm phút, thế mà đã xảy ra chuyện gì thế này?
        ...
        Vi Vi muốn khóc mà không có nước mắt, bất lực gõ chữ phản hồi: “Bạn à, mình chỉ là đến xem… cho…vui … thôi… mà…”`,
                ...
                {   chapter : "Chương 3",
                    name: 'Được cầu hôn',
                    content: `Gió nhẹ thổi qua, cành liễu thướt tha, chàng trai dưới gốc liễu toàn thân áo trắng không nhuốm bụi trần, khoác một cây đàn cổ, tà áo bay bay, rất có mùi vị phong độ xuất trần.
        ...
        Đại Thần đó!Thần tượng đó!
        
        Người có tiền đó!
        
        Vi Vi chạy xuống dưới cầu, gõ một cái mặt cười: “Nại Hà huynh nghe danh đã lâu, huynh kêu muội à?”
        
        Nhất Tiếu Nại Hà “ừ” một tiếng, sau đó hệ thống báo với Vi Vi: Nhất Tiếu Nại Hà đề nghị thêm bạn.
        
        Vi Vi vội vã nhấn nút đồng ý, cũng tiện thêm luôn Nhất Tiếu Nại Hà. Nhất Tiếu Nại Hà không phải là người dễ thêm bạn, danh sách bạn của các cao thủ cấp cao đều thường xuyên đóng kín, Vi Vi có lúc bị quá nhiều người thêm bạn nên đôi khi cũng phải đóng lại.
        ...
        Vi Vi lại cảm thấy choáng.
        
        Có điều nói đi nói lại thì nếu không vì nhiệm vụ, không vì PK, cô hà cớ gì phải đi kết hôn với người lạ chứ? Vả lại phần thưởng hậu hĩnh như thế…
    ...
    {truyen : {
        ...
        noidung : [
            {   chapter : "Chương 1",
                name: 'Mở đầu',
                content: `HỒI CÒN NHỎ, NHỎ XÍU, TÔI KHÔNG CÓ bạn gái. Suốt ngày tôi chỉ chơi với... mẹ tôi và bà nội tôi. Mẹ tôi rất thương tôi nhưng vìmẹ sợ ba nên ít khi mẹ che chở được tôi trước những trận đòn của ba tôi. Bà tôi thì lại khác. Bà sinh ra ba nên ba phải sợ bà. Điều đó thật may mắn đối với tôi.
        ...
        *****
        ...
        Có lần thằng Toản, một đứa mới vào học, chưa biết oai thằng Hòa, bị thằng Hòa trấn lột. Toản thoi thằng Hòa một quả trúng quai hàm. Ngay lập tức, thằng Hòa nằm lăn xuống đất ăn vạ, chân giãy đành đạch. Tụi tôi đứng coi, sợ xanh mặt.
        ...
        Trong những ngày gian khổ đó, tôi đã làm quen với Mắt Biếc, người bạn gái đầu tiên trong đời.`,
            ...
            {   chapter : "Chương 2",
                name: 'Nhà quê',
                content: `HỒI ĐÓ, TÔI CHƯA GỌI MẮT BIẾC LÀ MẮT BIẾC. Tôi gọi nó là Hà Lan, như mọi người vẫn gọi.
        ...
        *****
        ...
        - Con gái cởi truồng khác với con gái mặc quần áo, bà ạ.Bà tôi giật thót:
        ...
        *****
        ...
        Bao giờ tôi và Hà Lan quay trở lại trường cũng đúng vào giờ tan học. Điều đó luôn luôn khiến tôi đặc biệt thích thú.`,
            ...
            {   chapter : "Chương 3",
                name: 'Lớn lên',
                content: `Tôi và Hà Lan càng ngày càng chơi thân với nhau. Những năm lớp bốn, lớp năm, hai đứa tôi không chỉ cặp kè với nhau trong lớp mà khi về nhà, tôi và Hà Lan cũng không rời nhau nửa bước.
    ...
    {truyen : {
        ...
        noidung : [
            {   chapter : "Chương 1",
                ...
                content:`Ngày xửa ngày xưa, có hai chị em cùng cha khác mẹ, chị tên là Tấm, em tên là Cám. Mẹ Tấm mất sớm, sau đó mấy năm cha Tấm cũng qua đời, Tấm ở với dì ghẻ là mẹ Cám. Bà mẹ kế này rất cay nghiệt, bắt Tấm phải làm hết mọi việc nặng nhọc từ việc nhà đến việc chăn trâu cắt cỏ. Trong khi đó Cám được nuông chiều không phải làm gì cả.
...
Lông chim vàng anh chôn ở vườn hoá ra hai cây xoan đào. Khi vua đi chơi vườn ngự, cành lá của chúng sà xuống che kín thành bóng, như hai cái lọng. Vua thấy cây đẹp rợp bóng, sai lính hầu mắc vọng vào hai cây rồi nằm chơi hóng mát. Khi vua đi khỏi thì cành cây lại vươn thẳng trở lại. Từ đó, không ngày nào Vua không ra nằm hóng mát ở hai cây xoan đào.`,
            ...
            {   chapter : "Chương 3",
                name : `Kết truyện`,
                content: `Cám biết chuyện ấy lại về nhà mách mẹ. Mẹ nó bảo, cứ sai thợ chặt cây làm khung cửi rồi kiếm điều nói dối vua. Về đến cung, nhân một hôm gió bão, Cám sai thợ chặt cây xoan đào lấy gỗ đóng khung cửi. Thấy cây bị chặt, vua hỏi thì Cám đáp:
...
Mẹ Cám giận lắm, chửi mắng ầm ĩ rồi vác sào đuổi quạ. Nhưng đến ngày ăn gần hết, dòm vào chĩnh, mụ thấy đầu lâu của con thì kinh hoàng lăn đùng ra chết.`,
    ...
    {truyen : {
        title : "Lá thư thách đấu gửi Kudo",
        id: `4`,
        noidung : [
            {   chapter : "Chương 1",
                name :`Lá thư thách đấu gửi KUDO SHINICHI`,
                content: `Giới thiệu
        Một lá thư thách đấu được gửi tới Kudo Shinichi – cậu thám tử học trò nổi tiếng với khả năng phá những vụ án phức tạp!
        Hung thủ viết: “Ta sẽ bắt cóc học sinh trong chuyến dã ngoại cuối năm của Trường trung học Teitan”. Cuộc chiến sinh tử giữa hung thủ và Shinichi đã bắt đầu!!
        ...
        - Thông thường khi sáng tác truyện tranh, tác giả chỉ vẽ nhân vật, còn trợ lý sẽ đảm nhận phần bối cảnh và các chi tiết nhỏ. Tôi đã được xem bản gốc của các tác phẩm của ông ấy, và chú ý tìm hiểu quan sát rất kỹ càng. Dù ở bất cứ ô hình nào thì bối cảnh và các chi tiết nhỏ cũng được vẽ một cách rất hoàn hảo, chỉn chu và ăn khớp nhau. Nhờ các trang vẽ như vậy mà nhân vật chính của tác giả cũng như toàn bộ câu chuyện mới có sức hấp dẫn đủ để làm nên một tác phẩm thành công đến thế. Tôi nghĩ rằng nếu người trợ lý đó không tôn trọng tác giả, không yêu tác phẩm và nhân vật chính từ tận trái tim thì anh ta không thể làm tốt như vậy được.
        ...
        - Màn hình ti vi của chiếc di động chuyển sang cận cảnh gương mặt người dẫn chương trình bình luận có mái tóc bạch kim được tạo kiểu rẽ ngôi 3- 7.
        ...
        Giọng của hắn rất nhỏ nên mọi hành khách trong toa tàu không thể nào nghe thấy những lời dị thường ấy.`,
            ...
            {   chapter : "Chương 2",
                name : `Vụ bắt cóc đầu tiên`,
                content: `Vì mải xem những phát minh mới của tiến sĩ Agasa tại nhà tiến sĩ, nên khi Shinichi đứng lên ra về thì đã khá muộn. Đèn ở sảnh nhà tiến sĩ Agasa vừa sáng thì cửa mở, tiến sĩ Agasa và Shinichi bước ra.
...
- Các em chú ý! Thầy xin giới thiệu các hướng dẫn viên của Công ty Du lịch Teitan, những người sẽ đồng hành cùng chúng ta trong chuyến dã ngoại lần này.
Xin mời các vị tự giới thiệu đơn giản thôi ạ! - Thầy tổng phụ trách Tamaoki vừa nói vừa hướng về ba người mặc áo vét xanh rất nổi đang đứng cạnh mình.
...
Nhưng ngay sau đó, cậu lập tức nhớ lại chuyện tối qua.`,
            ...
            {   chapter : "Chương 3",
                name: `Giải mã`,
                content:`Khách sạn nơi đoàn Shinichi nghỉ lại nằm ở chân mỏm núi nhô ra biển, có kiến trúc theo kiểu Tây Ban Nha rất đáng yêu với tường trắng và ngói đỏ. Bao quanh là một màu xanh bát ngát của biển, bờ biển riêng của khách sạn có bãi cát trắng trải dài như được rải đường tinh luyện, lấp lánh dưới ánh mặt trời khiến người ta nhức mắt. Khi nhìn thấy bờ biển xanh ngăn ngắt qua khung cửa sổ lớn của khách sạn, cả đoàn học sinh đang tập trung tại sảnh không khỏi thốt lên những lời trầm trồ thán phục.
...
- Ha ha ha...- Thầy Kitajima không giấu nổi vẻ tự đắc trước ánh mắt ngưỡng mộ của học sinh cho dù chỉ có vẻn vẹn mười đứa.`,
    ...
    {truyen : {
        ...
        noidung : [
            {   chapter : "Chương 1",
                name :`Nguyên tắc 2 chữ t`,
                content:`NGUYÊN TẮC 2 CHỮ TNói về việc thông thạo tiếng Anh và tiếng Pháp của cầu thủ từ lò Hoàng AnhGia Lai (HAGL), bầu Đức chỉ cười , vì từ hơn chục năm trước, với tầm nhìntáo bạo của mình, ông đã hướng tới điều đó, bất chấp nhiều người cho là ông'nổ'  hay  'gàn'.  Ông  đã  chọn  Arsenal  vì  tư  duy  chơi  bóng  kỹ  thuật,  thôngminh. Qua giới thiệu của 'Giáo sư' Arsene Wenger, ông đã hợp tác với 'lò'JMG nổi danh vì có những triết lý phù hợp với bóng đá Việt Nam cũng nhưtriết lý trồng người: Trước hết phải là những công dân tốt, có ích, sau mới làcầu thủ.Nguyên tắc trồng người của HAGL dựa trên 2 chữ T là 'Tôn trọng' và 'Tiếnbộ'. Thứ nhất, học viên phải tôn trọng tất cả các yếu tố của bóng đá, trò chơi,người chơi, trọng tài, luật lệ và quy định... Điều này được quy chuẩn bằngvăn  bản  và  nội  quy,  hướng  các  cầu  thủ  trẻ  từ  những  ngày  đầu  bước  vàoTrung tâm Hàm Rồng phải theo khuôn phép của luật lệ. Sau đó là phát triểnnhân cách, để cho mỗi cá nhân cống hiến sức mạnh, nghị lực và khả năngcủa bản thân cho đồng đội, cho câu lạc bộ (CLB) của mình. Đó là lý do vìsao những Công Phượng, Xuân Trường... luôn biết vượt qua thị phi để cáccầu thủ trẻ noi theo.Tuy nhiên, trong quá trình đào tạo các cầu thủ trẻ đôi khi cũng có những khókhăn, bởi ở độ tuổi đó họ thường bốc đồng, thích làm theo ý mình. Như tiềnđạo Thanh Bình của U20 Việt Nam từng phạm lỗi nặng. Nhưng thay vì đuổi
        khỏi học viện, các thầy đã cùng ngồi lại chia sẻ, phân tích cho chàng trai cátính này. Chính văn hóa như một gia đình, cùng sự trân trọng tài năng đãgiúp Thanh Bình trưởng thành lên nhiều , để anh có cơ hội bước ra sân chơiWorld  Cup,  hứa  hẹn  sẽ  là  một  trong  những  chân  sút  chủ  lực  của  HAGLtrong vài năm tới.BẢN LĨNH TRƯỚC CÁM DỖBên cạnh những tiêu chí về đào tạo chuyên môn và học vấn, HAGL luônkiên trì với quan điểm tránh để các cầu thủ trẻ phải đối mặt với cám dỗ tiềnbạc quá sớm. Trưởng đoàn bóng đá HAGL Nguyễn Tấn Anh cho biết: "BầuĐức luôn tâm niệm các cầu thủ trẻ hãy tập trung rèn luyện, không vội dínhđến tiền bạc. Bởi vậy HAGL là học viện bóng đá đặc biệt trong cả nước khicác học viên chỉ lãnh một phần lương, số lớn còn lại được kế toán gửi trựctiếp về gia đình". Hằng ngày, vào buổi sáng các học viên đến trường để họcvăn hóa. Vào các buổi tối (trừ Chủ Nhật), các em sẽ được học ngoại ngữ(tiếng  Anh  và  tiếng  Pháp).  Thậm  chí  bầu  Đức  còn  thuê  những  giáo  viênngười  nước  ngoài  như  ông  Servano  Rene  Gajardo  (người  Philippines)  đểgiúp các em phát âm chuẩn.Còn nhớ khi cơn sốt U19 Việt Nam đang lên cao trào, cuối năm 2014 bầuĐức lẳng lặng khánh thành phân viện Hàm Rồng của Trường Đại học Sưphạm Thể dục Thể thao TP. HCM. Khi mọi người đang khen các chàng traigiỏi ngoại ngữ, có phông nền văn hóa tốt thì ông đã nghĩ xa hơn. Ít ngườibiết rằng ngoài lịch tập luyện và thi đấu dày đặc ở V-League cũng như cácđội tuyển quốc gia, những lãnh đạo CLB HAGL luôn vất vả duy trì lịch họcvăn hóa cho những chàng sinh viên - cầu thủ. Để làm sao trong vài năm tới,khi đủ trưởng thành trên sân cỏ làm trụ cột cho đội tuyển quốc gia, lứa CôngPhượng sẽ vững vàng khi trở thành một cử nhân chuyên ngành, có thể kiếmsống khi giải nghệ. Nhờ vậy, ngay ở tuổi 20 Xuân Trường đã tự tin hướngđến giấc mơ trở thành nhà quản lý thể thao, như Công Vinh đang làm.PVF,  VIETTEL  CŨNG  QUÁN  TRIỆT  DẠY  CẦU  THỦ  THÀNHNHÂNHà Đức Chinh là một thanh niên rất ngoan, có hiếu với bố mẹ, lễ phép vớicác  thầy  và  thân  thiện  với  cộng  đồng.  Chinh  là  một  trong  những  cầu  thủtrưởng thành từ lò đào tạo PVF.Huấn luyện viên (HLV) Nguyễn Việt Thắng cho biết: "Chúng tôi dạy dỗ cácem từ những thứ tưởng như nhỏ nhặt nhất. Ra sân tập phải xếp hàng, để giày
        thẳng hàng thẳng lối, không xả rác bừa bãi. Đi ăn phải tuyệt đối đúng giờ,đúng màu áo đội của mình. Chúng tôi cũng hướng các em tới những hoạtđộng mang tính cộng đồng, nhằm giúp các em thấu hiểu hơn những gì đangdiễn ra xung quanh mình. Cầu thủ không nên chỉ biết mỗi đá bóng mà cònphải biết thông cảm, sẻ chia. Cầu thủ thời đại mới phải có trái tim ấm áp.Những  HLV  như  chúng  tôi  thực  sự  mong  muốn  'tưới'  cho  các  em  nhữngdòng  nước  trong  lành  để  các  em  trở  thành  những  cây  xanh  không  bị  sâutrong tương lai".Thế hệ sau Hà Đức Chinh, từ lứa 10 tuổi trở đi, PVF cho học văn hóa tạiVinschool. Mỗi tuần các cầu thủ được học thêm 4 buổi tiếng Anh vào buổitối, với giảng viên Việt Nam và nước ngoài. Cũng 2 buổi trong tuần, họ đượcdạy kỹ năng sống, những kiến thức mà sách vở trường lớp không có.Chia sẻ với Thanh Niên về cách dạy làm người ở Trung tâm thể thao Viettel,thượng tá Hà Hữu Tám, Bí thư Đảng ủy, Phó giám đốc trung tâm, nói: "Giátrị cốt lõi của một đơn vị quân đội chính là truyền thống cách mạng, truyềnthống của người lính. Chúng tôi đặt ra 4 tiêu chí, trong đó văn hóa được ưutiên số 1. Văn hóa ở đây gồm cả văn hóa học đường và văn hóa ứng xử. Nếucầu thủ không được đào tạo, không được học hành nghiêm túc sẽ không cókiến thức nền".Theo  thượng  tá  Tám,  mỗi  cầu  thủ  của  Viettel  đều  phải  trải  qua  thời  gianhuấn  luyện  quân  sự,  họ  không  được  hưởng  chế  độ  ăn  300.000đồng/người/ngày của cầu thủ mà ăn đúng chế độ người lính để hiểu được sựvất vả mà có ý chí vươn lên. "Chỉ sau 1 tháng học quân sự, họ trưởng thànhlên rất nhiều. Chúng tôi muốn các cầu thủ Viettel mang phong cách của côngdân toàn cầu. Mục tiêu của Viettel không phải đào tạo cầu thủ lấy lợi nhuậnmà phục vụ cho Tổ quốc, cho quân đội", thượng tá Tám chia sẻ.CLB HÀ NỘI HƯỚNG CẦU THỦ TỚI CHÂN - THIỆN - MỸCLB  Hà  Nội  rất  tích  cực  tham  gia  các  hoạt  động  thiện  nguyện,  như  hằngnăm tham dự chương trình "Chạy vì trẻ em Hà Nội" hay hiến máu nhân đạotrong ngày "Chủ nhật đỏ". Các cầu thủ trẻ như Quang Hải, Duy Mạnh, ĐứcHuy, Thái Quý... là những nhân vật không bao giờ vắng mặt trong các sựkiện từ thiện này. Theo Chủ tịch CLB Nguyễn Quốc Hội: "Chúng tôi muốncầu thủ của mình hướng tới chân - thiện - mỹ. Một trong những cách làm tốtnhất là tham gia nhiều hoạt động xã hội, như thế không chỉ giúp kết nối conngười với con người, lan tỏa tinh thần tương thân tương ái mà còn là sự thểhiện trách nhiệm cao của đội bóng với xã hội"`,
                },
            {   chapter : "Chương 2",
                name: `Bùi Tiến Dũng`,
                content: `Trung vệ Bùi Tiến Dũng Chấn  thương  kéo  dài  đã  khiến  Bùi  Tiến  Dũng  không  thể  tham  dự  đầy  đủchuỗi trận giao hữu trước giải của U23 Việt Nam, nhưng HLV Park HangSeo vẫn kiên nhẫn giữ chỗ cho trung vệ này ở U23 Việt Nam, và cuối cùngniềm tin của ông thầy người Hàn Quốc đã được đền đáp xứng đáng, khi TiếnDũng kịp thời bình phục trước ngày khai mạc giải và tham gia trọn vẹn tất cảcác trận đấu của U23 Việt Nam.Thực ra không phải bây giờ mà từ cách đây vài năm, khi U23 Việt Nam cònlà U19 Việt Nam thì Tiến Dũng đã là trụ cột của hàng thủ dưới thời HLVGuillaume  Graechen,  rồi  HLV  Toshiya  Miura  và  HLV  Hữu  Thắng  ở  độituyển U23 Việt Nam, và không có gì ngạc nhiên khi HLV Park Hang Seocũng đặt trọn niềm tin vào Bùi Tiến Dũng sau khi ông lên nắm quyền.Tiến Dũng là trung vệ duy nhất của U23 Việt Nam được đề nghị tham gialoạt sút luân lưu 11m ở trận tứ kết với U23 Iraq và Tiến Dũng đã hoàn thànhxuất sắc nhiệm vụ ở lượt sút quyết định để giúp U23 Việt Nam đoạt vé vàobán kết.Trung vệ Trần Đình Trọng Đình Trọng là một trong những tuyển thủ U23 Việt Nam hiếm hoi lọt vàomắt xanh HLV Park Hang Seo ngay sau khi ông thầy này dự khán nhữngtrận đấu đầu tiên ở V-League 2017, và dưới thời HLV Park, Đình Trọng đãnhanh chóng chiếm giữ vị trí then chốt ở khu vực trung tâm hàng thủ củaU23 Việt Nam.Khi Bùi Tiến Dũng còn chưa góp mặt và Duy Mạnh vẫn chưa quen với việc
        thi đấu ở hàng thủ gồm 3 trung vệ thì Đình Trọng đã là một trong những cầuthủ chơi ổn định và đáng tin cậy nhất ở tuyến phòng ngự.Không những thế, Đình Trọng cũng là cái tên nhận được sự tín nhiệm khiU23 Việt Nam cần sự đột biến trong lối chơi, chẳng hạn như lúc chúng ta bịU23 Iraq dẫn trước 2-1 ở đầu hiệp phụ thứ 2, Đình Trọng từ vị trí trung vệđược đưa ra chơi hậu vệ phải và chính Đình Trọng đã góp công lớn vào bànthắng gỡ hòa 2-2 của U23 Việt Nam với cú tạt bóng khiến thủ môn U23 Iraqmắc lỗi, tạo điều kiện để Phan Văn Đức chớp cơ hội ghi bàn.Trung vệ Đỗ Duy Mạnh Đây là một trong những cái tên phải nhận vô số lời chỉ trích trong giai đoạnU23 Việt Nam chuẩn bị cho Vòng chung kết U23 Châu Á 2018, nhất là tạigiải giao hữu M-150 Cup tại Thái Lan, khi Duy Mạnh tỏ ra rất lúng túng vàlạc lõng ở sơ đồ hàng thủ gồm 3 trung vệ mà HLV Park Hang Seo bố trí choU23 Việt Nam.Là cầu thủ có sở trường ở vị trí tiền vệ trung tâm nhưng đã không ít lần đượcHLV sắp xếp chơi trung vệ, Duy Mạnh là một trong những cầu thủ chậmthích nghi nhất với sơ đồ 3-4-3 mà HLV Park Hang Seo áp dụng với U23Việt Nam, nhưng sự chậm chạp này chỉ diễn ra trong giai đoạn chuẩn bị, cònkhi bước vào giải đấu chính thức thì Duy Mạnh như đã lột xác hoàn toàn.Trên đất Trung Quốc, Duy Mạnh đã chơi rất chắc chắn và ổn định ở vị trítrung vệ, và người hâm mộ nhớ tới Duy Mạnh nhờ pha cứu thua ngay trênvạch cầu môn ở những phút cuối cùng của trận U23 Việt Nam - U23 Syria.Nếu không có tình huống cứu thua đó của Duy Mạnh thì có thể hành trìnhcủa U23 Việt Nam ở giải U23 châu Á đã kết thúc ngay sau vòng bảng.Hậu vệ trái Đoàn Văn HậuLà em út của đội tuyển U23 Việt Nam (sinh năm 1999) nhưng Văn Hậu lạilà cầu thủ sở hữu chiều cao tốt nhất (1m85) và lựa chọn đương nhiên cho vịtrí hậu vệ trái nếu như không gặp vấn đề về thể lực.Chính Văn Hậu là người thực hiện đường chuyền quyết định để Quang Hảighi bàn mở tỷ số trong trận U23 Việt Nam - U23 Hàn Quốc. Sự ăn ý giữaVăn Hậu và Quang Hải đã giúp cánh trái của U23 Việt Nam trở thành mộthướng tấn công nguy hiểm trong các trận đấu tại vòng bảng.Tuy nhiên, chấn thương rách bắp đã khiến Văn Hậu vắng mặt trong 3 trậnđấu tiếp theo ở vòng loại trực tiếp, và đây được xem là một tổn thất rất lớn
        với đội quân của HLV Park Hang Seo.Hậu vệ phải Vũ Văn ThanhKhông có nhiều hậu vệ Việt Nam được báo chí nước ngoài đánh giá cao nhờtư duy chiến thuật hiện đại và lối chơi công thủ toàn diện như Văn Thanh.Thuận chân phải nhưng Văn Thanh có thể chơi cực tốt ở vị trí hậu vệ trái, vàthực tế là sau khi Văn Hậu vắng mặt vì chấn thương, Văn Thanh đã quánxuyến hành lang trái một cách cực kỳ xuất sắc, giống như lúc Văn Thanhtừng tỏa sáng ở vị trí này tại AFF Cup 2016.Văn Thanh cũng là hậu vệ duy nhất đã tham dự trọn vẹn cả 2 cuộc đấu súngtrên chấm 11m của U23 Việt Nam, và cả 2 lần sút của Văn Thanh đều mangtính chất quyết định, bao gồm cú sút đầu tiên ở trận tứ kết với U23 Iraq và cúsút cuối cùng ở trận bán kết với U23 Qatar, trong đó đặc biệt đáng kể là cúsút 11m ở trận thắng U23 Qatar, khi Văn Thanh xung phong nhận sút ở lượtthứ 5 vì thấy các đồng đội đều không muốn sút quả này.Hậu vệ phải Phạm Xuân MạnhCùng với Phan Văn Đức, Phạm Xuân Mạnh cũng chỉ được góp mặt vào giờchót sau khi đã thi đấu ấn tượng ở U21 Quốc gia 2017 và được ông ParkHang Seo trực tiếp đưa lên đội tuyển U23 Việt Nam.Khác  với  Văn  Đức  được  làm  quen  dần  dần  với  không  khí  trên  sân,  XuânMạnh  bất  ngờ  được  đá  chính  sau  khi  Văn  Hậu  phải  nghỉ  thi  đấu  vì  chấnthương và Văn Thanh được kéo sang cánh trái, nhưng đã không có bất cứ sựlúng túng hay bỡ ngỡ nào từ phía Xuân Mạnh.Hậu vệ đang khoác áo SLNA đã hoàn thành xuất sắc nhiệm vụ nhờ lối chơicơ  động,  mạnh  mẽ,  rất  phù  hợp  với  vị  trí  chạy  cánh,  và  việc  Xuân  Mạnhđược HLV Park Hang Seo tin dùng trong suốt cả 3 trận đấu ở vòng loại trựctiếp chính là bằng chứng thuyết phục cho năng lực của cầu thủ này.`,
                },
            {   chapter : "Chương 3",
                name: `Một thế hệ kim cương `,
                content: `Tiền vệ Phạm Đức HuyRất hiếm khi xuất hiện trên mặt báo cũng như trong các khuôn hình nhưngĐức Huy vẫn là một trong những cầu thủ quan trọng nhất của U23 Việt Namở Vòng chung kết U23 Châu Á 2018. Ở CLB Hà Nội và cả ở đội tuyển U23Việt Nam dưới thời các HLV tiền nhiệm, Đức Huy thường được bố trí chơitiền vệ cánh phải hoặc thậm chí là hậu vệ phải, nhưng tại Vòng chung kếtU23 Châu Á 2018, Đức Huy được HLV Park Hang Seo sắp xếp ở vị trí tiềnvệ trung tâm.Công việc của Đức Huy là đảm nhiệm vai trò lá chắn trước hàng thủ và bọclót cho đội trưởng Xuân Trường. Vì thế, Đức Huy đã tham gia vào hầu nhưmọi cuộc chiến nóng bỏng nhất ở khu vực trung tuyến và dù Đức Huy khônglần nào có tên bảng tỷ số, nhưng nếu không có một nhân vật làm nhiệm vụdọn dẹp và thu hồi bóng như Đức Huy thì những cầu thủ ở tuyến trên nhưQuang Hải hay Phan Văn Đức khó lòng có cơ hội tỏa sáng.Tiền đạo Nguyễn Công PhượngSẽ  là  hơi  bất  công  khi  xếp  Công  Phượngvào  nhóm  này,  bởi  kể  từ  ngày"xuống núi", Công Phượng luôn được coi như là ngôi sao sáng giá nhất thếhệ mình. Tại giải giao hữu M-150 Cup diễn ra ngay trước thềm Vòng chungkết U23 Châu Á 2018, Công Phượng cũng chơi nổi bật với cú đúp bàn thắngvào lưới U23 Thái Lan.Tuy nhiên, ở Vòng chung kết U23 Châu Á 2018 thì vai trò của Công Phượngđã khác. Anh vẫn đã chính đều đặn ở tất cả các trận, nhưng ít khi ở lại trênsân cho tới lúc mãn cuộc và ở giải này Công Phượng lại có những đóng gópkhác, vẫn quan trọng nhưng lại khá thầm lặng.Đấy là pha bỏ bóng thông minh để Quang Hải sút tung lưới U23 Hàn Quốc,hay tình huống đi bóng lắt léo buộc hậu vệ U23 Uzbekistan phải phạm lỗi đểQuang Hải có cơ hội ghi bàn gỡ hòa 1-1 cho U23 Việt Nam từ chấm đá phạtở trận chung kết.Đấy là những pha đột phá và quấy rối không ngưng nghỉ ở 6 trận đấu củaU23 Việt Nam tại Vòng chung kết U23 Châu Á 2018, khiến hàng thủ đối
        phương mệt nhoài và mở ra khoảng trống cho các đồng đội khác, như QuangHải, như Văn Đức.Và đấy là bàn mở tỷ số ở trận tứ kết với U23 Iraq, giúp U23 Việt Nam cóđược khởi đầu thuận lợi để hướng thế trận theo ý muốn của mình.VŨ KHÍ BÍ MẬT TỪ BĂNG GHẾ DỰ BỊTiền đạo Hà Đức ChinhHà Đức Chinh được HLV Park Hang Seo xếp đá chính ở hai trận đầu tiên tạivòng bảng với U23 Hàn Quốc và U23 Australia, nhưng ông thầy người HànQuốc mau chóng nhận ra rằng Đức Chinh sẽ thích hợp hơn nếu được tungvào sân ở giữa hiệp 2, khi hàng thủ đối phương đã mệt nhoài và lơi lỏng sựcảnh giác sau những pha đột phá liên miên của Công Phượng.Và sự thật là Đức Chinh đã chơi tốt hơn sau khi được vào thay người, nhưtình huống tiền đạo này đánh đầu tung lưới U23 Iraq để nâng tỷ số lên 3-2 ởcuối  hiệp  phụ  thứ  2,  hay  pha  bóng  Đức  Chinh  suýt  nữa  xé  lưới  U23Uzbekistan với pha bay người đánh đầu lái bóng ở tầm thấp trong trận chungkết.Tiền đạo Nguyễn Văn ToànVăn Toàn luôn là cái tên được HLV Park Hang Seo nhớ tới đầu tiên khi cầncó một sự đột biến và tươi mới trên hàng công, chẳng hạn như khi U23 ViệtNam đang bị dẫn bàn ở trận tứ kết với U23 Iraq. Sau khi được tung vào sân,Văn Toàn đã góp công lớn trong tình huống dẫn tới bàn gỡ hòa 2-2 của U23Việt Nam, khi Văn Toàn cướp được bóng từ thủ môn U23 Iraq và chuyền racho Văn Đức trong tư thế không bị ai kèm.Tiền vệ Nguyễn Phong Hồng DuyHồng Duy được HLV Park Hang Seo cất kỹ trên băng ghế dự bị của U23Việt Nam và phải tới trận bán kết với U23 Qatar thì tiền vệ này mới đượctung vào sân. Chỉ không lâu sau khi xuất hiện trên sân, Hồng Duy đã biếncánh  trái  trở  thành  hướng  tấn  công  cực  kỳ  nguy  hiểm  của  U23  Việt  Nambằng khả năng đi bóng lắt léo và tốc độ của mình, buộc chân sút nguy hiểmnhất của U23 Qatar là Almoez Ali phải lùi sâu về sân nhà để theo kèm HồngDuy. Ở trận chung kết Hồng Duy cũng được đưa vào sân thay người nhưngtiếc là mặt sân bị đóng băng vì mưa tuyết đã cản trở khả năng cầm bóng vàdắt bóng của Hồng Duy.Trung vệ Nguyễn Thành Chung
        Giống như Văn Đức và Xuân Mạnh, Thành Chung cũng là một trong nhữngcầu thủ được triệu tập bổ sung vào giờ chót nhưng lại chiếm được một suấtchính thức tham dự Vòng chung kết U23 Châu Á 2018.Thành Chung được tung vào sân thay thế Duy Mạnh ở trận tứ kết với U23Iraq do Duy Mạnh bị chấn thương, và dù không có nhiều thời gian làm quennhưng Thành Chung vẫn chơi rất tốt trong những phút có mặt trên sân, gópphần giúp hàng thủ U23 Việt Nam đứng vững trước sức công phá dữ dội củaU23 Iraq.Tiền vệ Bùi Tiến DụngDo phong độ quá ổn định và chắc chắn của cặp Đức Huy - Xuân Trường nênTiến Dụng chỉ có thể vào sân từ ghế dự bị, nhưng trong cả 2 lần được HLVPark Hang Seo cho vào thay người thì Tiến Dụng đều thi đấu đạt yêu cầu. Làmột  trong  những  thành  viên  trẻ  tuổi  nhất  của  U23  Việt  Nam  (sinh  năm1998), Tiến Dụng vẫn còn rất nhiều cơ hội ở những kỳ giải sau.`,
                },
            ]
        },
    },
    {truyen: {
        ...
        noidung : [
            {   chapter : "Chương 1",
                name :`Để sống với những bóng ma, bắt buộc phải về nơi hoang dã`,
                content:`– ANNE MICHAELS, Fugitive Pieces (Những mảnh vụn phù du)
        ĐẰNG ĐẴNG NHIỀU NGÀY, tôi lùng khắp dãy Sierra Madre, Mexico
        theo dấu một bóng ma được biết đến với cái tên Caballo Blanco –
        Ngựa Trắng. Cuối cùng, tôi dừng chân ở điểm cuối đường mòn, nơi
        rốt cuộc tôi có thể ngờ sẽ thấy anh ta – không phải giữa sâu thẳm
        chốn hoang sơ như người ta đồn đoán, mà trong sảnh tối tăm của
        một khách sạn cũ kỹ, ngay rìa thị trấn bụi mù miền sa mạc.
        “Sí, El Caballo está.” Cô lễ tân gật đầu. Có, Ngựa Trắng ở đây.
        “Thật không?” Sau quá nhiều lần phải nghe rằng vừa vuột mất anh
        ta, ở quá nhiều địa điểm kỳ quặc, tôi bắt đầu nghi ngờ rằng Caballo
        Blanco chỉ là một huyền thoại không hơn, một quái vật hồ Loch
        Ness được thêu dệt để đe trẻ nít và bịp mấy gã nước ngoài khờ
        khạo.
        “Anh ta luôn trở lại đây đúng năm giờ.” Cô nói thêm. “Như một nghi
        lễ.”
        Tôi không biết nên ôm chầm cô gái vì sung sướng hay đập tay
        mừng chiến thắng. Tôi nhìn đồng hồ. Tôi sắp tận mắt trông thấy
        bóng ma chỉ sau… mà khoan đã.
        “Nhưng đã hơn sáu giờ rồi.”
        Cô lễ tân nhún vai. “Có lẽ anh ta đã đi rồi.”
        Tôi ngồi sụp xuống chiếc ghế xô-pha cổ lỗ sĩ. Tôi hôi hám, đói mềm,
        và thảm bại. Tôi đã cạn kiệt sức lực, và cạn kiệt cả đầu mối.
        Có người nói Caballo Blanco là dân tị nạn; người khác lại nghe, anh
        là võ sĩ quyền anh bỏ trốn để trừng phạt bản thân sau khi đánh chết
        một đấu thủ trên võ đài. Không ai biết tên, tuổi hay lai lịch. Anh như
        những tay súng miền Viễn Tây, chỉ để lại dấu vết là các câu chuyện
        nhiều hư cấu hay một hơi khói xì gà thoảng qua. Những lời mô tả và
        những lần chạm trán xuất hiện ở khắp mọi nơi trên bản đồ; người
        dân ở những ngôi làng cách xa nhau đến phi lý lại thề thốt rằng
        cùng nhìn thấy anh một ngày và những lời mô tả về anh khác nhau
        một cách kỳ lạ, từ “hài hước và dễ gần” cho đến “kỳ quặc và khổng
        lồ”.
        Nhưng trong tất cả các phiên bản về huyền thoại Caballo Blanco,
        vẫn có một số chi tiết cơ bản giống nhau: Anh tới Mexico từ nhiều
        năm trước và chuyển vào sâu trong vùng Barrancas del Cobre
        hoang vắng – Copper Canyon – để sống giữa những người
        Tarahumara (trong tiếng Tây Ban Nha, “h” là âm câm nên từ này
        được đọc là: Ta-ra-u-ma-ra), một bộ lạc kỳ bí, có những vận động
        viên siêu phàm từ thời kỳ đồ đá. Người Tarahumara có lẽ là giống
        người khỏe mạnh và thanh thản nhất Trái đất, và là những người
        chạy bộ vĩ đại nhất mọi thời đại.
        Nói tới các cự ly siêu dài, chẳng gì có thể đánh bại một người chạy
        bộ Tarahumara – kể cả ngựa đua, báo đốm, hay vận động viên
        marathon Olympic. Có rất ít người từng nhìn thấy người
        Tarahumara thể hiện sức mạnh, nhưng những câu chuyện kỳ thú về
        sức bền bỉ siêu phàm và sự bình thản của họ đã vượt khỏi các hẻm
        núi từ nhiều thế kỷ trước. Một nhà thám hiểm thề rằng ông ta đã
        nhìn thấy một người Tarahumara tay không bắt hươu, sau khi rượt
        đuổi con vật dẻo dai “đến long móng guốc” và khiến nó gục chết vì
        kiệt sức. Một người phiêu lưu mạo hiểm khác thì kể anh ta phải mất
        tới 10 tiếng đồng hồ trên lưng một con la để vượt qua một đỉnh
        trong Copper Canyon; trong khi một người Tarahumara chạy bộ hết
        chính quãng đường đó chỉ vỏn vẹn 90 phút.
        “Thử thứ này xem!” Có lần, một người phụ nữ Tarahumara nói với
        một nhà thám hiểm kiệt sức đã quỵ ngã dưới chân một ngọn núi. Bà
        đưa cho anh một quả bầu đựng thứ chất lỏng sẫm màu. Anh uống
        vài ngụm, và sửng sốt khi cảm thấy nguồn năng lượng mới chảy rần
        rật trong mạch máu. Anh lại đứng lên và leo tới đỉnh núi như một
        Sherpa uống quá liều caffein. Người Tarahumara, theo như lời nhà
        thám hiểm đó sau này kể lại, còn giữ bí mật về công thức chế biến
        một loại thực phẩm cung cấp năng lượng đặc biệt, giúp họ giữ được
        thân hình thon gọn, mạnh mẽ vô địch: chỉ một vài miếng loại thực
        phẩm đó là đủ dinh dưỡng chạy cả ngày không cần nghỉ.
        Nhưng bất cứ bí mật nào người Tarahumara gìn giữ, họ đều giữ rất
        kín. Ngày nay, người Tarahumara vẫn sống trên rìa những vách đá
        còn cao hơn tổ chim diều hâu, tại một vùng đất không còn mấy
        người từng thấy. Barrancas là một thế giới đã mất, nằm ở vùng
        hoang sơ hẻo lánh nhất Bắc Mỹ, một kiểu Tam giác Bermuda trên
        cạn, nổi tiếng vì đã nuốt chửng những kẻ không biết lượng sức hay
        liều lĩnh lạc bước vào đây. Đầy rẫy hiểm nguy chực chờ dưới những
        hẻm núi này; có sống sót được trước lũ báo ăn thịt người, rắn độc
        hay sức nóng đến rộp da, thì bạn vẫn còn phải đối phó với “cơn sốt
        hẻm núi”, một nỗi sợ chết người do cảm giác hoang vắng dị thường
        của Barrancas mang lại. Càng đi sâu vào Barrancas, bạn sẽ càng
        cảm thấy như bị đóng chặt lại trong một hầm mộ. Những bức tường
        khép lại, những cái bóng trải rộng ra, lời thì thầm của những bóng
        ma văng vẳng; lối đi nào tưởng như cũng dẫn đến những vách đá
        dựng đứng. Những người đi khai khoáng trước đây đã từng rơi vào
        tình trạng điên loạn và tuyệt vọng như thế, để rồi nhiều kẻ đã tự tay
        cắt cổ chính mình, hoặc gieo mình xuống vách đá. Vì vậy, chẳng lạ
        khi có rất ít người từng nhìn thấy mảnh đất quê nhà của người
        Tarahumara, chứ chưa nói đến chuyện gặp được người dân bộ lạc
        này.
        Nhưng bằng cách nào đó, Ngựa Trắng đã tới được những nơi sâu
        thẳm của Barrancas. Và ở đó, như người ta kể lại, anh được người
        Tarahumara chấp nhận như một người bạn và như một linh hồn
        thân thiện; một con ma giữa những bóng ma. Anh chắc chắn đã rèn
        luyện được hai kỹ năng của người Tarahumara – khả năng giấu
        mình và sức chịu đựng khác thường – bởi vì mặc dù người ta trông
        thấy anh khắp nơi trong hẻm núi, nhưng có vẻ như không ai biết
        anh sống ở đâu hay có thể tiếp tục xuất hiện ở nơi nào. Nếu có ai
        đó giải thích được những bí mật cổ đại của người Tarahumara, như
        tôi được nghe kể, thì đó chính là kẻ lang thang cô đơn này trên vùng
        núi cao Sierra.
        Tôi bị ám ảnh bởi việc tìm Caballo Blanco tới mức lúc ngủ gật trên
        ghế xô-pha ở sảnh khách sạn còn tưởng tượng ra giọng nói của
        anh. “Chắc là giống như giọng gấu Yogi hỏi mua burrito ở Taco
        Bell.” Tôi thầm nghĩ. Một người như thế, một kẻ lang thang đi bất cứ
        đâu, nhưng chẳng phù hợp với bất kỳ chốn nào, hẳn chỉ sống trong
        tâm tưởng của bản thân và hiếm khi nghe thấy tiếng của chính
        mình. Anh chắc sẽ kể các câu chuyện cười kỳ cục, và tự làm mình
        cười phá lên. Anh hẳn phải có tiếng cười bùng nổ và một giọng Tây
        Ban Nha tồi tệ. Anh chắc phải ồn ào, nói nhiều và… và…
        Chờ đã.`,
                },
            {   chapter : "Chương 2",
                name: `Tất cả bắt đầu từ đơn giản`,
                content: `Câu hỏi năm từ này đã dẫn tôi đến với tấm ảnh một người đàn ông
        chạy rất nhanh trong chiếc váy ngắn cũn cỡn, và rồi kể từ đây,
        những người tôi gặp ngày một thêm kỳ quái. Không lâu sau đó, tôi
        dính líu đến một vụ giết người, các băng đảng ma túy, và cả một gã
        đàn ông cụt một tay, với cái chén pho mát kem buộc trên đầu. Tôi
        đã gặp một nữ kiểm lâm tóc vàng xinh đẹp, cởi bỏ hết quần áo và
        tìm thấy sự cứu rỗi linh hồn khi chạy khỏa thân trong những khu
        rừng Idaho, một nữ vận động viên lướt sóng trẻ tuổi, tóc thắt bím,
        chạy thẳng vào chỗ chết ngoài sa mạc. Một thần đồng chạy bộ yểu
        mệnh. Hai người khác suýt cũng mất mạng.
        Tôi tiếp tục tìm kiếm, và còn tình cờ gặp cả Người Dơi Chân Đất…
        Gã Khỏa Thân… Những người sống trong bụi rậm ở Kalahari…
        Người cụt móng chân… và cuối cùng là bộ lạc Tarahumara cổ xưa,
        cùng gã học trò bí ẩn của họ, Caballo Blanco.
        Cuối cùng, tôi đã có được câu trả lời, nhưng chỉ sau khi nhận ra
        mình đang ở ngay trong cuộc đua vĩ đại nhất thế giới ngày nay: Giải
        vô địch Đối kháng môn chạy bộ, cuộc tỷ thí đỉnh cao giữa những
        người chạy bộ cự ly siêu dài giỏi nhất thời đại chúng ta với những
        người chạy bộ siêu dài giỏi nhất mọi thời đại, trong cuộc đua 50
        dặm trên những con đường mòn bí ẩn chỉ có dấu chân người
        Tarahumara. Tôi sẽ giật mình phát hiện ra rằng lời dạy cổ xưa của
        Lão Tử – “Kẻ khéo đi không để lại dấu vết” – không phải lời thuyết
        giảng sáo rỗng, mà thực sự là chỉ dẫn luyện tập nghiêm túc, cụ thể
        và thực tiễn.
        Tất cả bắt đầu vào một ngày tháng 1 năm 2001, khi tôi hỏi bác sĩ:
        “Tại sao chân tôi đau?”
        Tôi đã tới gặp chuyên gia hàng đầu về y học thể thao trong nước
        bởi có một cái que chọc vô hình nào đó cứ đâm thẳng vào gan bàn
        chân tôi. Tuần trước, khi đang chạy nhẹ nhàng khoảng ba dặm trên
        một con đường nông trại tuyết phủ, thì đột nhiên, tôi thét lên đau
        đớn, nắm chặt lấy bàn chân phải mà la hét chửi thề rồi ngã lăn
        xuống tuyết. Khi trấn tĩnh lại, tôi kiểm tra bàn chân, đinh ninh là đã
        đạp trúng mảnh đá nhọn, hoặc một cái đinh cũ kẹt trong lớp băng
        nào đó. Nhưng không hề có một giọt máu, thậm chí, giày cũng
        chẳng có lỗ thủng.
        “Chạy bộ chính là vấn đề của anh.” Bác sĩ Joe Torg khẳng định khi
        tôi lết vào phòng khám của ông ở Philadelphia vài ngày sau đó. Ông
        hẳn rõ hơn ai hết; bác sĩ Torg không chỉ gây dựng toàn bộ nền y học
        thể thao, mà còn là đồng tác giả cuốn The Running Athlete (Vận
        động viên chạy bộ), phân tích cụ thể bằng cách chụp X-quang tất cả
        các chấn thương có thể xảy ra khi chạy bộ. Ông kiểm tra X-quang
        và nhìn tôi tập tễnh đi loanh quanh, rồi kết luận rằng tôi đã làm
        thương tổn xương hộp, cụm xương nằm song song với hõm bàn
        chân mà tôi không hề biết là nó tồn tại, cho tới khi nó tự biến thành
        một que chích điện ngay trong bàn chân mình.
        “Nhưng tôi hầu như chẳng chạy mấy.” Tôi nói. “Tôi chỉ chạy mỗi lần
        khoảng hai đến ba dặm, cách một ngày chạy một lần. Và thậm chí
        tôi còn không chạy trên đường nhựa. Chủ yếu là đường đất.”
        Cũng chẳng ý nghĩa gì. “Cơ thể người không phải sinh ra để bị hành
        hạ như vậy.” Bác sĩ Torg trả lời. “Đặc biệt là cơ thể của anh.”
        Tôi hiểu ý ông. Với chiều cao 1,93 m, nặng 104 cân, tôi nhiều lần
        được khuyên rằng người có kích cỡ như tôi được tạo hóa sắp đặt
        đứng chắn dưới vòng bóng rổ hoặc đỡ đạn cho tổng thống, chứ
        không phải nện thân xuống nền đường. Và bước sang tuổi 40, tôi
        đã hiểu; trong năm năm từ khi ngừng chơi bóng rổ nửa sân và cố
        biến mình thành vận động viên marathon, tôi đã rách gân kheo (hai
        lần), bong gân Achilles (liên tục), lật cổ chân (cả hai bên, lúc bên
        này, lúc bên kia), đau hõm bàn chân (thường xuyên), phải đi giật lùi
        xuống cầu thang trên đầu ngón chân vì gót chân quá đau. Và bây
        giờ, điểm lành lặn duy nhất trên bàn chân tôi cũng tham gia nốt vào
        cuộc nổi loạn.
        Kỳ quặc là, với các hoạt động khác, tôi cứ như mình đồng da sắt. Là
        phóng viên cho tờ Men’s Health và một trong những người phụ
        trách đầu tiên của chuyên trang “Người không ngừng nghỉ” trên
        Esquire, phần lớn công việc của tôi là thử sức với các môn thể thao
        cực hạn. Tôi từng lướt ván xuôi những khúc sông có độ khó Cấp IV,
        trượt ván trên các đồi cát khổng lồ, đạp xe địa hình xuyên Badlands,
        Bắc Dakota. Tôi từng đi lấy tin ở ba vùng chiến sự cho Associated
        Press và ăn dầm nằm dề trong những khu vực hỗn loạn ở châu Phi,
        mà không hề hấn gì. Nhưng chỉ dợm chạy bộ vài dặm xuống phố, là
        tôi lại vật ra đất như thể vừa bị một kẻ lái xe ngang qua bắn hạ.
        Với bất kỳ môn thể thao nào khác, một chấn thương như vậy sẽ xếp
        tôi vào hàng phế phẩm. Trong chạy bộ, trường hợp như tôi lại là
        bình thường. Bất thường lại chính là những ai chạy bộ không bị
        chấn thương. Hằng năm, cứ 10 người chạy bộ thì có tám người bị
        chấn thương. Bất kể béo hay gầy, chạy nhanh hay chậm, nhà vô
        địch marathon hay người nổi hứng chạy cuối tuần, bạn đều có khả
        năng bị chấn thương đầu gối, ống đồng, gân kheo, hông hoặc gót
        chân. Lần tới, khi xếp hàng ở vạch xuất phát của một cuộc đua, hãy
        nhìn những người đứng bên trái hay bên phải bạn: theo số liệu
        thống kê, chỉ một người trong số các bạn có thể về đích mà vẫn dự
        được cuộc đua sau.
        Cho đến nay, chưa có cách nào để làm chậm lại sự tàn phá này;
        bạn có thể mua giày chạy bộ có lò xo thép đệm ở phần đế và các
        đôi giày Adidas đời mới điều chỉnh độ êm bằng vi mạch, nhưng tỷ lệ
        chấn thương lại không hề giảm bớt trong suốt 30 năm qua. Thậm
        chí, thực tế là còn tệ đi; tình trạng bong gân gót chân Achilles đã
        tăng khoảng 10%. Chạy bộ dường như là phiên bản thể thao của
        việc lái xe khi say rượu: bạn có thể bình an trong một thời gian,
        thậm chí có cả lúc vui thú, nhưng thảm họa luôn rình rập ngay sau
        mỗi lối rẽ.`,
                },
            {   chapter : "Chương 3",
                name: `Hơn thế nữa`,
                content: `Tạp chí Runner’s Worldgiao nhiệm vụ cho tôi đi vào vùng Barrancas
        để tìm người Tarahumara. Nhưng trước khi bắt đầu tìm kiếm những
        bóng ma, tôi cần tìm được người săn ma. Tôi được mách nước
        rằng Salvador Holguín là người duy nhất làm được việc này.
        Ban ngày, Salvador 31 tuổi là một nhân viên hành chính tại
        Guachochi, thị trấn vùng biên ngoài rìa Copper Canyon. Đêm đến,
        anh trở thành ca sĩ hát nhạc mariachi tại quán bar, và quả thực, nhìn
        anh cũng hợp với việc đó; với cái bụng bia và cặp mắt đen, vẻ điển
        trai lãng mạn, anh đích xác là hình ảnh một người có cuộc sống chia
        đôi, nửa cho bàn giấy và nửa cho ghế tròn quán bar. Anh trai
        Salvador lại là mẫu Indiana Jones của hệ thống trường học Mexico;
        năm nào anh cũng chất đầy lên lưng lừa nào bút chì, sách vở và lẻn
        vào vùng Barrancas để cung cấp cho các ngôi trường dưới lòng
        thung lũng. Vì Salvador luôn sẵn sàng tham gia mọi trò vui, nên anh
        thỉnh thoảng lại trốn việc đi theo anh mình trong các chuyến thám
        hiểm này.
        “Không hề gì đâu ông bạn!” Anh trả lời khi tôi tới gặp. “Chúng ta có
        thể đi gặp Arnulfo Quimare…”
        Nếu anh dừng ngay ở đó, thì tôi hẳn đã mừng. Trong khi đi tìm
        người dẫn đường, tôi mới hay Arnulfo Quimare là người
        Tarahumara chạy bộ vĩ đại nhất hiện còn sống, và anh đến từ một
        thị tộc gồm những người anh em họ, anh em ruột, anh em vợ cùng
        các cháu đều giỏi ngang ngửa mình. Đi thẳng đến các căn lều bí ẩn
        của họ tộc Quimare còn hơn cả những gì tôi mong mỏi. Duy có điều
        Salvador vẫn nói liên hồi.
        “… Tôi chắc chắn là mình biết đường.” Anh tiếp. “Tôi thực ra chưa
        bao giờ tới đó. “Pues, lo que sea.” Ôi dào, sao cũng được. “Chúng
        ta sẽ tìm được thôi. Kiểu gì cũng tìm được!”
        Thường thì, đó có vẻ là điềm xấu, nhưng nếu so với tất cả những
        người mà tôi từng trò chuyện, Salvador xem ra có vẻ lạc quan. Từ
        khi trốn chạy vào vùng đất không người 400 năm trước, người
        Tarahumara đã dành thời gian để biến nghệ thuật tàng hình của
        mình thành hoàn hảo. Đa phần người Tarahumara vẫn đang sống
        trong các hang động cheo leo trên vách đá, chỉ có thể leo lên bằng
        các cây sào dài; khi đã vào bên trong, họ sẽ rút cây sào ra và biến
        mất sau bờ đá. Những người khác lại sống trong các túp lều được
        ngụy trang tài tình tới mức, nhà thám hiểm người Na Uy Carl
        Lumholtz từng giật thột khi đi qua cả ngôi làng Tarahumara mà tịnh
        không thấy bóng người hay nhà cửa.
        Lumholtz thực sự là một tay lang thang cự phách ở vùng hẻo lánh,
        ông từng sống nhiều năm giữa đám săn đầu người ở Borneo trước
        khi tiến vào lãnh địa của người Tarahumara vào cuối những năm
        1890. Nhưng bạn có thể thấy ngay sức chịu đựng ngoan cường của
        ông cũng bị mài mòn sau bao năm tháng lê thân qua các sa mạc và
        vách đá tử thần, để rồi cuối cùng, khi tới được trái tim xứ
        Tarahumara, vẫn chẳng tìm thấy ai.
        “Ngắm nhìn những rặng núi này sẽ cho ta cảm giác phấn chấn tinh
        thần, nhưng leo qua chúng lại làm kiệt quệ cả cơ bắp lẫn lòng nhẫn
        nại.” Lumholtz đã viết như vậy trong Unknown Mexico: A Record of
        Five Year’s Exploration Among the Tribes of the Western Sierra
        Madre (Một Mexico chưa được biết đến: Ghi chép về năm năm
        thám hiểm các bộ lạc ở dãy Sierra Madre phía Tây). “Không ai, trừ
        những người từng vượt qua các ngọn núi ở Mexico, có thể hiểu hết
        nỗi nhọc nhằn và lo lắng khi tham gia một hành trình như vậy.”
        Và đấy là nếu như bạn có thể tới được những ngọn núi ấy. “Khi mới
        tới nơi, vùng đất của người Tarahumara cứ như thể không cách gì
        tiếp cận được.” Nhà biên kịch người Pháp Antonin Artaud đã cằn
        nhằn như vậy, sau khi ông ta phải vã mồ hôi mới nhích được từng
        xentimét trên đường vào Copper Canyon tầm sư học đạo. “Nhiều
        lắm cũng chỉ có vài lối mòn được đánh dấu sơ sài, mà cứ vài chục
        mét lại như thể biến mất vào lòng đất.” Khi Artaud và đội dẫn đường
        cuối cùng cũng phát hiện thấy một lối đi, họ cũng phải trấn tĩnh một
        lúc trước khi tiến bước: bởi người Tarahumara luôn theo phương
        sách tốt nhất để làm nản lòng những kẻ đuổi theo mình là đi tới
        những nơi mà chỉ có kẻ điên mới dám vào theo. Cứ như thế, họ đã
        tạo nên những lối mòn ngoằn ngoèo trên những địa hình dốc đứng
        mà việc đi theo chẳng khác nào tự sát.
        “Một bước sẩy chân,” nhà phiêu lưu Frederick Schwatka ghi vào sổ
        tay trong chuyến thám hiểm Copper Canyon vào năm 1888, “sẽ
        ném thẳng người leo núi xuống đáy vực sâu từ 60 đến 90 mét, chết
        không toàn thây.”
        Schwatka hoàn toàn không phải thi sĩ Paris kiểu cách, ông là một
        trung sĩ Lục quân Hoa Kỳ, từng vào sinh ra tử ngoài chiến trận và
        sau đó từng sống giữa cộng đồng người Sioux với tư cách một nhà
        nhân học nghiệp dư, nhờ vậy, ông biết thế nào là chết không toàn
        thây. Ông cũng từng kinh qua những vùng đất tệ hại nhất, trong đó
        có cả một cuộc thám hiểm khủng khiếp trong hai năm ở Vòng Bắc
        Cực. Nhưng khi tới Copper Canyon, ông đã phải sửa lại bảng xếp
        hạng của mình. Lướt nhìn biển hoang mạc chung quanh, Schwatka
        chợt dâng lên niềm ngưỡng mộ – “Trái tim dãy Andes hay các đỉnh
        của dãy Himalaya cũng không có nhiều cảnh quan hùng vĩ hơn tầng
        tầng lớp lớp núi non hoang dã chưa được biết tới của dãy Sierra
        Madre ở Mexico.” Và rồi ngay lập tức, ông bị kéo trở lại với nỗi
        hoang mang đến phát bệnh: “Làm thế nào nuôi dạy lũ trẻ trên
        những vách đá với tỷ lệ sống sót 100% hằng năm, đối với tôi, là một
        trong những điều bí hiểm nhất ở những con người kỳ lạ này.”
        `,
                },
            ],
        },
    ...
    {truyen : {
        ...
        noidung : [
            {   chapter : "Chương 1",
                name :`Thịnh vượng trong thời bấp bênh`,
                content: `Trong số 25 tác phẩm có ảnh hưởng nhất thế giới về quản trị trong
        thế kỷ 20 theo bình chọn của Tạp chí Time thì đã có tới 2 tác phẩm
        của Jim Collins, đó là: “Xây dựng để trường tồn” (Build to Last) và
        “Từ tốt đến vĩ đại” (Good to Great).
        Chưa hết, trong số 20 tác phẩm có ảnh hưởng nhất thế giới về
        quản trị trong vòng 20 năm qua theo bình chọn của Tạp chí Forbes
        cũng có 2 tác phẩm của Jim Collins: “Xây dựng để trường tồn” (Build
        to Last) và “Từ tốt đến vĩ đại” (Good to Great).
        Và trong hầu hết mọi cuộc bình chọn danh sách những nhà tư
        tưởng quan trọng nhất về quản trị (management thinkers) trong
        nhiều năm qua thì tên của Jim Collins luôn nằm ở top đầu.
        Tất cả những điều này cũng đủ nói lên tầm vóc và sự ảnh hưởng
        của Jim Collins đối với lĩnh vực quản trị cũng như đối với nền kinh
        thương của thế giới trong suốt hơn một thập niên qua.
        Năm 2007, Nhà xuất bản Trẻ và Trường Doanh Nhân PACE đã
        phối hợp để biên dịch và phát hành 2 tác phẩm kinh điển nói trên
        của Jim Collins và được đông đảo doanh nhân và những người
        quan tâm đến quản trị ở Việt Nam đón nhận nồng nhiệt và đã được
        tái bản nhiều lần kể từ lần đầu xuất bản bằng tiếng Việt
        Và nay, sau nhiều năm chờ đợi của độc giả, của các nhà lãnh đạo
        doanh nghiệp và các nhà nghiên cứu trên khắp thế giới, Jim Collins
        (cùng với Morten T. Hansen) đã cho ra đời một tác phẩm mới (mà
        theo đánh giá và kỳ vọng của nhiều chuyên gia cũng sẽ là một trong
        những tác phẩm kinh điển về quản trị trong thế kỷ 21), đó là: “Vĩ đại
        do lựa chọn” (Great by Choice).
        Tác phẩm này cũng được Trường Doanh Nhân PACE cho đưa
        vào “Tủ sách doanh trí” của trường (bao gồm những tác phẩm quan
        trọng nhất và kinh điển nhất về quản trị của thế giới và Việt Nam,
        do PACE tuyển chọn và giới thiệu).
        Nội dung của cuốn sách này là kết quả của một công trình nghiên
        cứu đồ sộ và kéo dài 9 năm do Jim Collins và Morten T. Hansen chủ
        trì để nỗ lực trả lời một câu hỏi quan trọng bậc nhất của các doanh
        nhân và các nhà quản lý trong thời đại ngày nay, đó là:
        Tại sao có một số công ty thịnh vượng trong tình trạng bấp
        bênh, thậm chí là điên đảo, trong khi các công ty khác thì không?
        Và với nội dung và mục tiêu như vậy, cuốn sách này càng trở nên
        quan trọng đối với những người đang nắm giữ số phận của doanh
        nghiệp ở Việt Nam trong một thời kỳ đầy bất ổn, nhiều bất trắc cả
        về kinh tế, chính trị lẫn văn hóa, cả trong nước lẫn môi trường quốc
        tế và toàn cầu.
        Với những ý nghĩa và giá trị như vậy, chúng tôi, Nhà xuất bản Trẻ
        và Trường Doanh Nhân PACE hân hạnh giới thiệu đến Quý vị độc
        giả cuốn sách quý này`,
                },
            {   chapter : "Chương 2",
                name : `Những công ty 10x   `,
                content : `Chúng ta không thể đoán trước tương lai. Nhưng chúng ta có thể
        tạo ra nó.
        Hãy nhớ lại xem chuyện gì đã xảy ra trong khoảng 15 năm trở lại
        đây, toàn những chuyện bất ổn – trên thế giới, trong nước, trên các
        thị trường, trong công việc và đời sống của bạn – không ai có thể
        ngờ đến. Chúng ta có thể ngạc nhiên, thấy phiền toái, bị sốc, sững
        sờ, vui sướng, hoặc kinh sợ, nhưng ít khi nào liệu trước được. Không
        ai trong chúng ta có thể đoán chắc được những khúc quanh của đời
        mình. Cuộc sống thật bấp bênh và tương lai thì mù mờ. Điều này
        chẳng tốt mà cũng chẳng xấu. Nó đúng là thế, giống như trọng lực
        vậy. Thế nhưng nhiệm vụ thì vẫn y nguyên: ngay cả vậy, bạn phải
        làm sao để làm chủ số phận của chính mình.
        Vào năm 2002, chúng tôi đã bắt đầu một dự án nghiên cứu kéo
        dài chín năm để chuẩn bị cho quyển sách này, khi mà nước Mỹ thức
        tỉnh khỏi cảm giác sai lầm về sự ổn định, an toàn và quyền được
        thịnh vượng. Thị trường đầu cơ giá lên dài hạn bị sụp đổ. Ngân sách
        chính phủ từ thặng dư bỗng chốc hóa ra thiếu hụt. Các cuộc khủng
        bố ngày 11 tháng 9 năm 2001 khiến người người khắp nơi nơi khiếp
        sợ và giận dữ; và rồi theo đó là chiến tranh. Trong khi ấy, ở khắp nơi
        trên thế giới, thay đổi công nghệ và cạnh tranh toàn cầu vẫn tiếp
        tục cuộc hành quân không mệt mỏi và đầy tính đột phá của nó.
        Toàn bộ những chuyện trên dẫn đến một câu hỏi đơn giản: Tại
        sao có một số công ty thịnh vượng trong tình trạng bấp bênh, thậm
        chí là điên đảo, trong khi các công ty khác thì không? Khi bị vùi dập
        bởi các sự kiện hỗn độn, khi bị tác động bởi các ngoại lực mạnh mẽ
        và thay đổi mau lẹ mà chúng ta không thể dự đoán hay kiểm soát,
        thì điều gì tạo nên sự khác biệt giữa những người thực hiện tốt một
        cách phi thường với những người thực hiện dưới mức yêu cầu hoặc
        quá tệ?
        Chúng tôi không chọn những câu hỏi này để nghiên cứu. Chính
        chúng đã chọn chúng tôi. Đôi khi một trong những câu hỏi cứ thộp
        ngay cổ họng của chúng ta và gầm gừ, “Ta sẽ không thả tay ra để mi
        thở chừng nào mi chưa trả lời ta!” Nghiên cứu này tóm lấy chúng
        tôi bởi nỗi bất an dai dẳng và sự giày vò của cảm giác dễ bị tấn công
        trong một thế giới ngày càng trở nên mất trật tự. Câu hỏi trên không
        chỉ thú vị về mặt trí tuệ mà còn liên quan đến cá nhân. Và khi chúng
        tôi làm việc với các sinh viên và các nhà lãnh đạo thuộc lĩnh vực
        kinh doanh lẫn lĩnh vực xã hội, chúng tôi cũng cảm nhận được nỗi
        bất an này ở họ. Trong những năm thuộc quãng thời gian này, các
        sự kiện diễn ra cũng chỉ củng cố thêm cảm giác bất an đó. Rồi tiếp
        theo sẽ ra sao? Tất cả những gì mà chúng ta biết chính là: không ai
        biết rồi sẽ ra sao...
        Thế nhưng có một số công ty và nhà lãnh đạo vẫn lèo lái cực kỳ
        tốt trong cái thế giới đó. Họ không chỉ phản ứng mà là sáng tạo cái 
        mới; không chỉ sống sót mà là chiến thắng; không chỉ thành công
        mà là thịnh vượng. Họ xây dựng những công ty vĩ đại có khả năng
        trường tồn. Chúng tôi không tin rằng cái tình trạng hỗn loạn, bấp
        bênh và bất ổn này là tốt; các công ty, các nhà lãnh đạo và các xã
        hội sẽ không thịnh vượng nhờ sự hỗn loạn. Thế nhưng họ vẫn có
        thể thịnh vượng trong tình trạng hỗn loạn.
        Để trả lời câu hỏi họ đã làm điều đó như thế nào, chúng tôi bước
        vào tìm kiếm các công ty khởi đầu từ vị trí yếu ớt, đã phát triển
        thành những công ty vĩ đại với thành tích đầy ngoạn mục. Họ đã
        làm được như thế trong những môi trường bất ổn, bị tác động bởi
        các ngoại lực mạnh mẽ, ngoài tầm kiểm soát, biến đổi nhanh, bấp
        bênh và tiềm ẩn sự nguy hại. Sau đó chúng tôi so sánh những công
        ty này với một nhóm giới hạn các công ty đã không thể trở nên vĩ
        đại cũng trong những môi trường cực độ ấy, sử dụng sự đối lập giữa
        kẻ thắng và người thua để khám phá những yếu tố tạo nên sự khác
        biệt đã cho phép một số người trở nên thịnh vượng trong điều kiện
        bấp bênh.`,
                },
            {   chapter : "Chương 3",
                name : `Hành trình 20 dặm`,
                content : `Để nắm được phần cốt lõi nghiên cứu của chúng tôi, hãy xem
        một trường hợp 10X: hãng hàng không Southwest Airlines. Hãy nhớ
        lại mọi thứ đã tấn công vào ngành hàng không từ năm 1972 đến
        năm 2002: Khủng hoảng xăng dầu. Giảm bớt các quy định quản lý
        của Chính phủ. Xung đột lao động. Các cuộc đình công của kiểm
        soát không lưu. Những cuộc suy thoái làm tê liệt mọi thứ. Lãi suất
        tăng vọt. Không tặc. Phá sản liên tiếp. Và vào năm 2001 là cuộc tấn
        công khủng bố ngày 11 tháng 9. Ấy vậy mà nếu quý vị đã đầu tư
        10.000 đôla vào Southwest Airlines vào ngày 31/12/1972 (lúc đó hãy
        còn là một đội bay nhỏ xíu với 3 máy bay, vừa đủ đạt hòa vốn, bị
        các hãng hàng không lớn hơn phong tỏa nhằm tiêu diệt những kẻ
        mới vào nghề) thì khoản vốn 10.000 đôla này sẽ tăng lên gần 12
        triệu đôla vào cuối năm 2002, một mức lãi cao hơn thị trường chứng
        khoán phổ thông 63 lần. Kết quả này tốt hơn cả Wal-Mart, hơn cả
        Intel, hơn cả GE, hơn cả Johnson & Johnson, hơn cả Walt Disney.
        Thật vậy, theo như phân tích của tạp chí Money, Southwest Airlines
        chiếm vị trí số 1 về mức lợi nhuận đầu tư trong danh sách các công
        ty S&P 500 được niêm yết công khai vào năm 1972 và giữ vị trí này
        tròn 30 năm cho đến năm 2002.3
         Đấy là những kết quả hết sức ấn
        tượng dù có đo lường theo kiểu nào, nhưng chúng sẽ khiến quý vị
        kinh ngạc khi kể đến hoàn cảnh đầy giông tố, những khủng hoảng
        cực kỳ bất ổn và sự bấp bênh kinh niên hiện diện trong môi trường
        kinh doanh của Southwest.
        Tại sao Southwest đã khắc phục được nghịch cảnh? Họ đã làm
        gì để làm chủ số phận? Và họ đã làm thế nào để đạt được thành tích
        hàng đầu trong khi các hãng hàng không khác không làm được?
        Cụ thể hơn, tại sao Southwest trở nên vĩ đại trong một môi trường
        cực độ như vậy trong khi đối thủ cạnh tranh trực tiếp của họ, hãng
        Pacific Southwest Airlines (PSA), lại thất bại và không còn đáng là
        đối thủ cạnh tranh nữa mặc dù có cùng một mô hình kinh doanh,
        trong cùng một ngành, với cùng cơ hội để trở thành vĩ đại? Chính
        sự đối lập này lột tả được cốt lõi vấn đề nghiên cứu của chúng tôi.
        Nhiều sinh viên và độc giả đã hỏi chúng tôi rằng: “Nghiên cứu
        này có gì khác so với nghiên cứu trước cũng về những công ty vĩ
        đại, đặc biệt là ở các tác phẩm Xây dựng để trường tồn và Từ Tốt
        đến Vĩ đại?” Phương pháp nghiên cứu giống nhau (phân tích so
        sánh lịch sử) và vẫn là vấn đề về sự vĩ đại. Nhưng không giống bất
        kỳ nghiên cứu nào trước đây, trong nghiên cứu này, chúng tôi đã
        chọn những trường hợp để nghiên cứu không chỉ dựa vào thành
        tích hay hình tượng mà còn dựa vào tính cực độ (extremity) của
        môi trường.
        Chúng tôi lựa chọn theo thành tích kèm thêm môi trường vì
        hai lý do. Thứ nhất, chúng tôi tin rằng tương lai vẫn là điều không
        thể đoán trước và thế giới vẫn sẽ bất định trong suốt phần đời còn
        lại của chúng ta, và chúng tôi muốn hiểu những yếu tố giúp phân
        biệt được các tổ chức vĩ đại, những tổ chức đã chiến thắng những
        xung đột cực độ, trong những môi trường như thế. Thứ hai, bằng
        việc nghiên cứu các công ty và các nhà lãnh đạo trong những môi
        trường cực độ, chúng tôi có được những nhận thức sâu sắc mà hẳn
        vẫn sẽ bị che giấu khi nghiên cứu các nhà lãnh đạo ở những bối
        cảnh yên bình hơn. Hãy tưởng tượng quý vị đang tản bộ nhàn hạ,
        lang thang qua những đồng cỏ ấm áp ngập tràn ánh nắng, và người
        đồng hành của quý vị là một nhà leo núi vĩ đại, người đã dẫn đầu
        những cuộc chinh phục các đỉnh núi phản trắc nhất thế giới. Có lẽ
        quý vị sẽ nhận thấy anh ta có đôi chút khác biệt so với người khác,
        ví như cảnh giác hơn trước các dấu vết, hoặc xếp đồ đạc vào ba lô
        cẩn thận hơn. Nhưng nhìn chung, với một ngày xuân an toàn và rực
        rỡ, sẽ khó lòng thấy được điều gì thực sự đã khiến nhà leo núi tài ba `,
                },
            ],
        },
    },
    {truyen : {
        title : "Vi sinh vật vi tính",
        id : `9`,
        noidung : [
            {   chapter : "Chương 1",
                name : `Chương 1`,
                content: `Theo bạn thì cái nào nhỏ nhất?
        a)Ví tiền của bạn.
        b)Não của ông thầy.
        ...
        Tập trung nhìn... thật tập trung... có thấy gì không?`,
            ...
            {   chapter : "Chương 2",
                name : `Chương 2`,
                content : `Những câu đố này dễ đến nỗi bạn có thể trả lời ngay lập tức! Thật
        đấy! Chỉ cần bạn sáng ý thôi!
        1 Mỗi khi bạn đi xe đạp, chiếc lốp xe sẽ để lại một vệt... SU CAO
        nóng chảy mờ nhạt.
        2 Nấm sinh ra các hạt nhỏ xíu gọi là bào tử. Khi ánh Mặt trời chiếu
        vào, chúng đen sậm đi như khi bạn... NẶNG SÁM.
        3 Khi ra ngoài, đầu tóc, quần áo và hai lỗ mũi của bạn bị phủ kín
        bởi hàng ngàn hạt nhỏ xíu gọi là... BUI NẶNG.
        4 Trong mỗi giọt mưa đều có những hạt bụi mịn. Một số đến từ...
        GIÔNG KHAN.
        ...
        Công việc mài kính có lẽ phải mất vài ngày làm cật lực.`,
            ...
            {   chapter : "Chương 3",
                name : `Chương 3`,
                content : `Bạn sẽ nhận thấy con bọ chét to ra – nhưng tại sao? Đầu mối đây:
...
let tenTruyen = document.getElementById("tenTruyen");
...
let dropDown = document.getElementById ("dropdown-menu");
    ...
    main.onclick = function(e){
        ...
        ten.innerText = data[e.target.id-1].truyen.title;
        tenTruyen.appendChild(ten);

        //Thêm items cho dropdown
        for(let i=0; i<data[e.target.id-1].truyen.noidung.length; i++){
            let a = document.createElement("a");
            a.className = "dropdown-item";
            a.setAttribute('id',i);
            a.innerText = data[e.target.id-1].truyen.noidung[i].chapter;
            dropDown.appendChild(a);
            console.log(data[e.target.id-1].truyen.title)
        }

        //Thêm nội dung
        let noiDung = document.getElementById("noi-dung");
        let text = document.createElement("div");
        text.innerText = data[e.target.id-1].truyen.noidung[0].content;
        button.innerText = data[e.target.id-1].truyen.noidung[0].name;
        noiDung.appendChild(text);

        dropDown.onclick = function(q){
            text.innerText = data[e.target.id-1].truyen.noidung[q.target.id].content;
            title.innerText = data[e.target.id-1].truyen.noidung[q.target.id].name;
            button.innerText = data[e.target.id-1].truyen.noidung[q.target.id].chapter;
        }
